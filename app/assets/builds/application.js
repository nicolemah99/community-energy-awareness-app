...
%o`, message, error2, detail);
  ...
  (function() {
    ...
    function displayWeather(data) {
      const { name: location2, main: { feels_like, temp, humidity }, wind: { speed: wind_speed, deg: wind_degree }, weather: [{ description: weather_description, main: weather, icon: iconCode }] } = data;
      locationElement.textContent = `${location2}, AK`;
    ...
    }).then(displayWeather).catch((error2) => {
      console.error("There was a problem with your fetch operation:", error2.message);
    });
  })();
  ...
  function setUpDatePickers() {
    ...
    let currentHourDate = /* @__PURE__ */ new Date();
  ...
  function drawSavingsChart() {
    ...
    if (window.savingsChartObj)
      window.savingsChartObj.destroy();
